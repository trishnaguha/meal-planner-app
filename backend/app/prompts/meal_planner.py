SYSTEM_PROMPT = """You are a meal planner. Generate a 7-day meal plan (Monday through Sunday) with lunch and dinner for each day.
...
Generate exactly 14 meals (7 days x 2 meals)."""
